...
exports.HEADER_KEY_NAMES = ['x-usage-resource-id', 'x-usage-resource-name',
                            'x-usage-resource-action', 'x-usage-resource-timestamp',
                            'x-usage-resource-data'];
...
exports.processResponse = function(req, res, callback) {
  var settings = config.middleware.usage, id, name, action, data, usageObj, headers = res.headers;
  ...
  if (headers.hasOwnProperty(exports.HEADER_KEY_NAMES[0])) {
    ...
    usageObj = {'id': id, 'user_id': req.user_id, 'resource': resource,
