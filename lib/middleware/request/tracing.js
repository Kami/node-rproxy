...
var client = new KeystoneClient(settings.auth.url, {'username': settings.authentication.username,
                                                    'apiKey': settings.authentication.apiKey});
exports.SERVICE_NAME = 'rsr:node-rproxy';
exports.tracer = tracers.RESTkinTracer(settings.restkin.url, client);

exports.dependencies = ['identity_provider'];

exports.processRequest = function(req, res, callback) {
  var t = trace.Trace.fromRequest(req, SERVICE_NAME);
